...
| width 	| Number | 200      |超过屏幕宽度自动转为屏幕宽度|剪裁框宽度|否|
| height        | Number | 200      |超过屏幕高度自动转为屏幕高度|剪裁框高度|否|
...
| pushImg       |  src   	   |   无   |开始剪裁图片|是|
| getImg        |Function(回调函数) |   src  |获取剪裁之后的图片路径|是|
| setWidth     	|  width   	   |   无    |设置剪裁框宽度|是|
| setHeight     |  height   	   |   无    |设置剪裁框高度|是|
